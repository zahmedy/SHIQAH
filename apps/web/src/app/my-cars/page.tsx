...
export default function MyCarsPage() {
  ...
  const text = locale === "ar"
    ? {
        ...
        sessionExpired: "جلسة الدخول منتهية أو مفقودة. سجّل دخولك من جديد.",
        loadListingsFailed: "ما قدرنا نحمّل إعلاناتك.",
        loginRequired: "لازم تسجّل دخولك.",
        submitSuccess: (carId: number) => `تم إرسال السيارة #${carId} للمراجعة.`,
        submitFailed: "ما قدرنا نرسل الإعلان.",
        userIdRequired: "اسم المستخدم العام مطلوب.",
        userIdUpdated: (nextUserId: string) => `تم تحديث اسم المستخدم العام إلى @${nextUserId}.`,
        userIdUpdateFailed: "ما قدرنا نحدّث اسم المستخدم العام.",
        approveSuccess: (carId: number) => `تمت الموافقة على السيارة #${carId}.`,
        approveFailed: "ما قدرنا نوافق على الإعلان.",
        ...
        rejectFailed: "ما قدرنا نرفض الإعلان.",
        title: "حسابك",
        subtitle: "كل إعلاناتك وحسابك بمكان واحد.",
        profileKicker: "لوحة التحكم",
        createDraft: "أنشئ إعلان",
        loading: "جارٍ التحميل...",
        refresh: "تحديث",
        account: "الحساب",
        accountHelp: "اسم المستخدم يطلع في المحادثات وتقدر تغيّره بأي وقت.",
        profileMember: "عضو GARAJ",
        accountSummary: "هوية الحساب",
        listingsSection: "إعلاناتك",
        listingsSectionHelp: "تحكم بالنشر والمراجعة والتعديلات من مكان واحد.",
        totalListings: "إجمالي الإعلانات",
        liveListings: "المنشورة",
        pendingListings: "تحت المراجعة",
        ...
        loginRequiredForCars: "لازم تسجّل دخولك عشان تشوف حسابك.",
        noListingsYet: "ما عندك إعلانات للحين.",
        cityNotSet: "الموقع مو محدد",
        createdOn: (value: string) => `انضاف ${value}`,
        review: "المراجعة",
        fixAndResubmit: "عدّل وأرسل من جديد",
        ...
        approve: "موافقة",
        reject: "رفض",
        openPublicListing: "افتح الإعلان",
        publicPageAfterActive: "الصفحة العامة تظهر إذا صار الإعلان نشط.",
        currentStatus: "حالة الإعلان",
      }
    : {
